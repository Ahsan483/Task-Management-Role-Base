...
__decorate([
    (0, typeorm_1.Column)({ type: 'varchar', default: TaskStatus.TODO }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, (user) => user.createdTasks, { eager: true }),
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => organization_entity_1.Organization, (org) => org.tasks, { eager: true }),
